  ...
  render() {
    return (
      <Container className="App">
        ...
        <Row className="blurb">
          <p>This webapp contains tools that explore the group actions of music on the Dihedral group <InlineMath math="D_{12}"/> discussed in <i>Musical Actions on Dihedral Groups</i> (paper can be found <a href="https://arxiv.org/abs/0711.1873" target="_blank" rel="noreferrer">here</a>). In particular, the tools allow users to play around with group operations, visualize the group actions, and listen to the musical output.</p>
        </Row>
        <Row className="blurb">
        ...
        <Row className="blurb">
          <p>For a brief discussion of Serialism, the music analysis technique used in the paper, notes can be partioned into 12 pitch classes, one for each semitone. Thus we can operate on notes under addition modulo 12. For example:</p>
          <ul>
        ...
        <Row className="blurb">
          <p className="link-paragraph">Below are links to the pages with the tools I developed for the T/I Group and PLR Group discussed in the paper (also can be navigated to from the navbar on top). Each page contains a description of how the group works and contains an interactive tool at the bottom demonstrating how the group works.</p>
          <ul>
        ...
        <Row className="blurb">
          ...
          <p>Source code can be found <a href="https://github.com/michaelli00/d24-music" target="_blank" rel="noreferrer">here</a>.</p>
        </Row>
